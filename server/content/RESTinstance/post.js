...
module.exports = (req, res) => 
{
    ...
    if (params.length <= 2) {
        ...
        const domain = params.splice(0, 1)[0];
        const domainInstance = serverUtils.getDomain(domain);
        const parentrelationship = params.splice(0, 1)[0];
	...
	const parent = domainInstance.getParentEntityByRelationshipName(relationship);
        ...
        const parentTargetEntity = parent.getRelationshipByName(relationship);
	console.log(parentTargetEntity);
    	const entity = parentTargetEntity.getTargetEntity();
	...
	console.log("not embedded but not root entity");
    	return Promise.resolve(createNewDoc(id,persistence,domain,collection,parent,entity,parentTargetEntity,req,res));
