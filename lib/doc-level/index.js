        ...
        switch (key) {
            ...
            case TYPES.RELATIONSHIP:
                return Promise.resolve()
                    ...
                    .then((relationship) => {
                        // FIXME: Hack for parentClass.
                        if (relationship.name === 'parentClass') {
                            return {
                                model: {
                        ...
                        } else if (relationship.name === 'targetEntity') {
                            console.log("instance=", instance);
                            throw new Error(`TODO targetEntity`);

                        } else {
                            return getRelationshiptData(docLevel.remainder(), persistence, relationship, instance);
                        }
                    })
                ;
