...
const SpecialRelationships = require('./../core/special-relationships');
    ...
    if (first) {
        ...
        switch (key) {
            ...
            case constants.TYPES.RELATIONSHIP: {
                return Promise.resolve()
                    .then(() => {
                        if (value === SpecialRelationships.PARENT_CLASS) {
                            return {
                                model: {
                        ...
                        } else if (value === SpecialRelationships.TARGET_ENTITY) {
                            return {
                                model: {
                                    addValue(persistence, type, id, instance) {
