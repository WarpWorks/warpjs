...
const findDocsFromSearchTerm = require('./find-documents-from-search-term');
                ...
                if (implementation) {
                    ...
                    switch (currentCommand.command) {
                        case "Create":
                            ...
                            if (!value.parentID) {
                                throw new WarpJSError("Failed to create new entity - parent ID is missing!");
                            }
