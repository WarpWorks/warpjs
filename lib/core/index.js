        ...
        return Promise.resolve()
            ...
            .then((persistence) => Promise.resolve()
                ...
                .then((dbDomain) => {
                    ...
                    const domainInfo = this.domains.find((domainInfo) => domainInfo.schema.name === domainName);
                    ...
                    return Promise.resolve()
                        .then(() => models.Domain.fromPersistenceJSON(this, persistence, dbDomain))
                        .then((domain) => {
                            this.domains = this.domains.filter((domainInfo) => domainInfo.name !== domainName).concat({
                                schema: domain,
