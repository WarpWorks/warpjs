...
class User {
    ...
    async getDisplayImage(persistence, req) {
        if (isUndefined(this._displayImage)) {
            const document = new Document(this.domainName, this.userDocument);
            this._displayImage = await document.getDisplayImageUrl(persistence, req) || null;
        }
    ...
    async listNotifications(persistence) {
        const Notification = require('./notification');
        return Notification.fromUser(this.domainName, this.userDocument);
    }
}
