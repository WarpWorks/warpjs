...
class EnumPanelItem extends PanelItem {
    ...
    static fromFileJSON(jsonData, parent) {
        ...
        const newEnumPanelItem = new EnumPanelItem(parent, jsonData.id, jsonData.name, jsonData.desc);
    ...
    static fromPersistenceJSON(persistence, json, parent) {
        return Promise.resolve(new EnumPanelItem(parent, json.warpjsId, json.name, json.description))
