        ...
        return Promise.resolve()
            .then(() => {
                if (this.name === 'targetEntity') {
                    // FIXME: Hack for targetEntity
                    return relativeToDocument.href;
                } else {
                    return RoutesInfo.expand(routes.relationship, {
                        domain,
            ...
            .then((resource) => Promise.resolve()
                // .then(() => console.log(`relationship: name=${this.name}, getTargetEntity()=`, this.getTargetEntity()))
                .then(() => {
