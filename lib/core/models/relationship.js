...
class Relationship extends Base {
    ...
    toFormResource(persistence, instance, docLevel, lastDocumentLevelHref) {
        ...
        return Promise.resolve()
            ...
            .then((docs) => {
                ...
                return this.getTargetEntity().toFormResource(persistence, instance, docLevel, docs, lastDocumentLevelHref);
            })
            .then((model) => {
