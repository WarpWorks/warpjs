...
class Relationship extends Base {
    ...
    static fromFileJSON(jsonData, parent) {
        ...
        instance.sourceRole = jsonData.sourceRole;
        instance.sourceMax = jsonData.sourceMax;
        instance.sourceMin = jsonData.sourceMin;
        instance.sourceAverage = jsonData.sourceAverage;
        instance.targetRole = jsonData.targetRole;
        instance.targetMin = jsonData.targetMin;
        instance.targetMax = jsonData.targetMax;
        instance.targetAverage = jsonData.targetAverage;
    ...
    static fromPersistenceJSON(persistence, json, parent) {
        return Promise.resolve()
            .then(() => new Relationship(parent, json.targetEntity, json.warpjsId, json.isAggregation, json.name, json.description))
            .then((instance) => Promise.resolve()
                .then(() => {
                    instance.sourceRole = json.sourceRole;
                    instance.sourceMin = json.sourceMin;
                    instance.sourceMax = json.sourceMax;
                    instance.sourceAverage = json.sourceAverage;
                    instance.targetRole = json.targetRole;
                    instance.targetMin = json.targetMin;
                    instance.targetMax = json.targetMax;
                    instance.targetAverage = json.targetAverage;
                })
                .then(() => instance)
            )
        ;
