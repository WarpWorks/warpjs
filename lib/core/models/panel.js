...
class Panel extends Base {
    ...
    addNewSeparatorPanelItem() {
        ...
        const newSeparatorPanelItem = new SeparatorPanelItem(this, id);
    ...
    addNewRelationshipPanelItem(name, desc, relationship) {
        const id = this.getDomain().createNewID();
        const newRelationshipPanelItem = new RelationshipPanelItem(this, id, name, desc, relationship);
    ...
    addNewBasicPropertyPanelItem(name, desc, basicProperty) {
        const id = this.getDomain().createNewID();
        const newBasicPropertyPanelItem = new BasicPropertyPanelItem(this, id, name, desc, basicProperty);
    ...
    addNewEnumPanelItem(name, desc, enumeration) {
        const id = this.getDomain().createNewID();
        const newEnumPanelItem = new EnumPanelItem(this, id, name, desc, enumeration);
    ...
    addNewAction(name, desc, enumeration, icon, functionName) {
        const id = this.getDomain().createNewID();
        const newAction = new Action(this, id, name, desc, enumeration);
        newAction.icon = icon;
    ...
    processLocalTemplateFunctions(template) {
        const aggregationPanelItems = [];
        const associationPanelItems = [];
        for (const i in this.relationshipPanelItems) {
            const rpi = this.relationshipPanelItems[i];
