...
class Panel extends Base {
    ...
    toPersistenceJSON() {
        return _.extend({}, super.toPersistenceJSON(), {
            ...
            embedded: [
                this.mapChildrenPersistenceJSON(71, 'separatorPanelItems', this.separatorPanelItems),
                this.mapChildrenPersistenceJSON(72, 'relationshipPanelItems', this.relationshipPanelItems),
                this.mapChildrenPersistenceJSON(73, 'basicPropertyPanelItems', this.basicPropertyPanelItems),
                this.mapChildrenPersistenceJSON(74, 'enumPanelItems', this.enumPanelItems),
                this.mapChildrenPersistenceJSON(75, 'actions', this.actions)
            ]
        });
    }
