...
class Entity extends Base {
    ...
    async clone(persistence, instance, parentID, version) {
        ...
        if (this.isDocument() && version) {
            debug(`clone(): Fixing versioned clone.`);
            ...
            if (!parentID) {
                ...
                nameBasicProperty.setValue(instance, currentName);
            }
            ...
            if (statusEnum) {
                ...
                if (currentStatus !== DOCUMENT_STATUS.INHERITANCE) {
            ...
            if (predecessorRelationship) {
                ...
                debug(`FIXME: Remove current predecessor.`);
