...
class Entity extends Base {
    ...
    save(persistence, domainPersistenceId) {
        return Promise.resolve()
            ...
            .then((entityPersistenceId) => Promise.resolve()
                .then(() => Promise.each(
                    []
                        .concat(this.getBasicProperties())
                        .concat(this.getRelationships())
                        .concat(this.getEnums())
                        .concat(this.getPageViews())
                        .concat(this.getTableViews())
                    ,
    ...
    fromPersistenceJSON(persistence, json) {
        return Promise.resolve()
            ...
            // Relationships
            .then(() => this.PersistenceCollection(persistence, Relationship, 'relationships'))
