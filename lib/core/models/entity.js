...
class Entity extends Base {
    ...
    toPersistenceJSON() {
        return _.extend({}, super.toPersistenceJSON(), {
            ...
            // Child elements:
            embedded: [
                this.mapChildrenPersistenceJSON(17, 'basicProperties', this.getBasicProperties(true)),
                this.mapChildrenPersistenceJSON(21, 'enums', this.getEnums(true)),
                this.mapChildrenPersistenceJSON(18, 'relationships', this.getRelationships(true))
            ]
        });
    }
