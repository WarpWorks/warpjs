...
class BaseChangeLog {
    ...
    href(routes, domain, type, id) {
        return RoutesInfo.expand(routes.instance, { domain, type, id });
    }
    ...
    toFormResource(domain, persistence, cache, routes) {
        throw new Error(`Not implemented '${this.constructor.name}.toFormResource(domain, persistence, cache, routes)'.`);
    }
