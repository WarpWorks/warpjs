...
- #316: Aggregation documents created with parent document's version.

## 1.3.175 - 2019-09-12

- #326: All documents are visible if user is logged in.

## 1.3.174 - 2019-09-11

- #318: Fixed best document to compute status before sorting.
...
- #302: PDF Download opens new tab/window.

## 1.3.169 - 2019-09-06

- #310: Adding document status definition to meta document editor.

## 1.3.168 - 2019-09-06

- #304: PDF acknowledgements for WG and TG.

## 1.3.167 - 2019-09-06

- #301: Portal view: remove indentation for subdocuments.
...
- #303: Implemented ReleaseDate and removed deprecated document number.
